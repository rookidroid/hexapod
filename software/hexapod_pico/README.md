...
> **Legacy:** this firmware is no longer maintained. It has no web calibration or real-time streaming, and it does not use the robot selection in [`hexapod_esp32`](../hexapod_esp32/). Its `motion.h` was generated for [Nougat](../../robots/nougat/)'s geometry. For another robot, copy that robot's `software/hexapod_esp32/src/robots/<name>/motion.h` over it. The ESP32 firmware is recommended.
