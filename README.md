...
| 18650 Battery Holder | <img src="./images/battery_box.jpg" alt="battery_holder" width="300"/>                                                                       | 1          | 2-cell holder with wire leads     | A 3D-printable holder is available [here](https://github.com/rookidroid/hexapod/blob/mochi/3d%20print/18650%20battery%20holder%202S1P.stl)                                    |
...
5. **Open and Configure Code**:
   ...
   - Edit [`config.h`](./software/hexapod_esp32/config.h) to set your WiFi credentials (default: SSID="hexapod_nougat", password="hexapod_1234"):
...
├── images/              # Photos, assembly animations and the wiring diagram
└── software/
...
- `config.h`: Configuration settings and calibration offsets
...
| ------- | ------- | ------------------ |
| WiFi SSID | `hexapod_nougat` (ESP32), `hexapod` (Pico) | `APSSID` in `config.h` |
...
- Verify SSID and password in `config.h` (default: hexapod_nougat/hexapod_1234 for ESP32, hexapod/hexapod_1234 for Pico)
